  ...
  return (
    <div
      ...
      className={cn(
        ...
        "after:pointer-events-none after:absolute after:inset-0 after:-scale-y-100 after:opacity-0 after:shadow-md after:content-[''] after:[clip-path:inset(0_0_-1rem_0)]",
        '[[data-slot=drawer-popup][data-body-overflow-y-end]_&]:after:opacity-100',
