...
<div flexDirection='row' gap='400' alignItems='center'>
...
<div flexDirection='row' gap='400' bg='neutral.surface.strong' p='400' borderRadius='md'>
  <NoteMusic />
  <NoteMusic outline />
</div>
```
