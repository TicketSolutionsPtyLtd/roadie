...
```tsx
live
<View flexDirection='row' gap='400' alignItems='center' bg='neutral.surface.strong' p='400' borderRadius='200'>
  <NoteMusic />
  <NoteMusic outline />
</View>
```
...
live
<View flexDirection='row' gap='400'>
  <NoteMusic boxSize='800' bg='surface.subtle' p='300' borderRadius='200' />
</View>
```
