...
A dropdown list of actions that opens from a button, built on Base UI's menu primitive.
...
```tsx-live
<Menu>
  <Menu.Trigger render={<IconButton aria-label='More actions' emphasis='subtle'><DotsThree weight='bold' className='size-4' /></IconButton>} />
  <Menu.Content>
    <Menu.Item icon={<PencilSimple weight='bold' />} shortcut='⌘E'>Edit</Menu.Item>
    <Menu.Item icon={<Copy weight='bold' />} shortcut='⌘D'>Duplicate</Menu.Item>
    <Menu.LinkItem href='https://example.com/events/neon-harbour-sessions' icon={<ArrowSquareOut weight='bold' />}>View on site</Menu.LinkItem>
    <Menu.Separator />
    <Menu.Item intent='danger' icon={<XCircle weight='bold' />}>Cancel event</Menu.Item>
  </Menu.Content>
</Menu>
```
...
<Menu>
  ...
  <Menu.Content>
    <Menu.Item icon={<PencilSimple weight='bold' />}>Edit</Menu.Item>
    <Menu.Item icon={<Download weight='bold' />} disabled>Download tickets</Menu.Item>
    <Menu.Separator />
    <Menu.Item intent='danger' icon={<Trash weight='bold' />}>Delete draft</Menu.Item>
  </Menu.Content>
</Menu>
```
...
`Menu.LinkItem` takes an `href`, like every Roadie link. Internal paths route through `RoadieLinkProvider`, and external URLs open in a new tab. The menu closes when a link is followed.

```tsx-live
<Menu>
  <Menu.Trigger render={<Button>Go to<CaretDown weight='bold' className='size-4' /></Button>} />
  <Menu.Content>
    <Menu.LinkItem href='/components/menu#links'>Orders</Menu.LinkItem>
    <Menu.LinkItem href='/components/menu#links'>Attendees</Menu.LinkItem>
    <Menu.LinkItem href='https://example.com/help'>Help centre</Menu.LinkItem>
  </Menu.Content>
</Menu>
```
...
<Menu>
  ...
  <Menu.Content>
    <Menu.Group>
      ...
      <Menu.Item icon={<Download weight='bold' />}>Download CSV</Menu.Item>
      <Menu.Item icon={<Envelope weight='bold' />}>Email to me</Menu.Item>
    </Menu.Group>
    <Menu.Separator />
    <Menu.Group>
...
<Menu>
  ...
  <Menu.Content>
    <Menu.Item icon={<PencilSimple weight='bold' />}>Edit</Menu.Item>
    <Menu.Item icon={<Copy weight='bold' />}>Duplicate</Menu.Item>
    <Menu.SubmenuRoot>
      <Menu.SubmenuTrigger icon={<ShareNetwork weight='bold' />}>Share</Menu.SubmenuTrigger>
      <Menu.Content>
        <Menu.Item icon={<LinkSimple weight='bold' />}>Copy link</Menu.Item>
        <Menu.Item icon={<Envelope weight='bold' />}>Email</Menu.Item>
      </Menu.Content>
    </Menu.SubmenuRoot>
    <Menu.Separator />
    <Menu.Item intent='danger' icon={<XCircle weight='bold' />}>Cancel event</Menu.Item>
