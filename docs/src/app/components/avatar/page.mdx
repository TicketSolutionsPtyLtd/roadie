...
A person's photo, with their initials or an icon when there is no photo. Built on Base UI's avatar primitive.
...
```tsx-live
<Avatar
  src='https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=112&h=112&fit=crop&q=80'
  name='Mia Tran'
/>
```
...
<div className='flex flex-wrap items-end gap-6'>
  ...
  <div className='grid justify-items-center gap-2'>
    <Avatar src='https://example.invalid/missing.jpg' name='Ada Nguyen' />
...
<Avatar size='lg'>
  ...
  <Avatar.Image
    src='https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=112&h=112&fit=crop&q=80'
    alt='Mia Tran'
  />
</Avatar>
```
...
<div className='flex items-center gap-3'>
  <Avatar.Group size='sm' aria-label='Going'>
    <Avatar
      src='https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=64&h=64&fit=crop&q=80'
      name='Sam Okafor'
    />
    <Avatar
      src='https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=64&h=64&fit=crop&q=80'
      name='Priya Shah'
    />
