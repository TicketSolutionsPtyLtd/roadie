...
A single panel that a trigger shows and hides, built on Base UI's collapsible primitive. It opens with the same height motion and caret turn as Accordion.
...
<Collapsible className='grid gap-3'>
  <div className='flex flex-wrap items-center gap-2'>
    ...
    <Collapsible.Trigger render={<Button />}>
      <SlidersHorizontal weight='bold' className='size-4' />
      Advanced filters
    </Collapsible.Trigger>
  </div>
...
<div className='grid gap-6'>
  ...
  <div className='grid justify-items-start gap-1'>
    ...
    <Collapsible>
      <Collapsible.Trigger showIndicator={false}>Show all 12 ticket types</Collapsible.Trigger>
      <Collapsible.Panel><p className='pt-2'>Early bird, student and nine more.</p></Collapsible.Panel>
    </Collapsible>
  </div>
</div>
