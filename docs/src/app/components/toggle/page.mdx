...
The same sizes as `Button`. A toggle with an `aria-label` renders square, for an icon-only toggle.
...
<div className='grid gap-4'>
  ...
  <div className='flex flex-wrap items-center gap-2'>
    <Toggle size='xs' aria-label='Bold'><TextB weight='bold' /></Toggle>
    <Toggle size='sm' aria-label='Bold'><TextB weight='bold' /></Toggle>
    <Toggle size='md' aria-label='Bold'><TextB weight='bold' /></Toggle>
    <Toggle size='lg' aria-label='Bold'><TextB weight='bold' /></Toggle>
  </div>
</div>
```
...
- Give an icon-only toggle an `aria-label`. It also makes the toggle square.
