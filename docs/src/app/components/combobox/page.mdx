...
<div className='grid gap-2'>
  <Combobox>
    <Combobox.InputGroup emphasis='default'>
      <Combobox.Input placeholder='Default emphasis' />
      <Combobox.Trigger />
    </Combobox.InputGroup>
  </Combobox>
  <Combobox>
  ...
  return (
    <Combobox items={bands}>
      <div className='grid gap-1.5'>
        <label className='text-sm font-medium text-default'>Favourite band</label>
        <Combobox.InputGroup>
          <Combobox.Input placeholder='Search bands...' />
          <Combobox.Clear />
          <Combobox.Trigger />
...
### Combobox vs Autocomplete (future)

Autocomplete will be for **free-text input with suggestions** — the user's typed
value is always valid, suggestions just help. Think address fields or search bars.

| Question | Select | Combobox | Autocomplete (future) |
|---|---|---|---|
