...
In a [Navigator](/components/navigator) app, top toasts already clear the tallest [Pane.Header](/components/pane) along the top of the window and follow it as it collapses. Set `--toast-viewport-offset-top` only for other fixed UI; it adds to that.
