...
Add `download` to an `href` icon button to save the file instead of opening it, optionally under a filename.

```tsx-live
<IconButton aria-label='Download spec' href='/spec.pdf' download='spec.pdf'>
