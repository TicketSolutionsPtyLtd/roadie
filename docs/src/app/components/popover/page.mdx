...
A popover opens below its trigger by default and re-flips to stay in view. Set `positionerProps` on `Popover.Content` to control placement with these props:
