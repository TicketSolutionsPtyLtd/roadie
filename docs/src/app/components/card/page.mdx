  ...
  <div className='grid gap-2'>
    ...
    <div className='grid rounded-2xl bg-subtle p-4 intent-brand'>
      <Card variant='ticket' direction='vertical' emphasis='raised' intent='neutral'>
        ...
        <Card.Footer className='grid content-center gap-4 text-center'>
          <div className='grid'>
            <p className='text-display-ui-4 text-strong'>28</p>
            <p className='text-sm text-subtle'>tickets</p>
          </div>
          <div className='grid'>
            <p className='text-display-ui-4 text-strong'>7</p>
            <p className='text-sm text-subtle'>shared</p>
          </div>
        </Card.Footer>
      </Card>
    </div>
