...
A number input with buttons to step the value down and up, built on Base UI's number field primitive.
...
function TicketQuantities() {
  ...
  return (
    <div className='grid max-w-md gap-4'>
      <p className='text-display-ui-6 text-strong'>Midnight Tram, Corner Hotel stage</p>
