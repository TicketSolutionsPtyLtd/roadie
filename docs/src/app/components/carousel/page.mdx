  ...
  <Carousel.Content>
    ...
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          <Card.Title>Static Bloom</Card.Title>
          <Card.Description>Saturday 12 Apr — Eatons Hill Hotel</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          <Card.Title>Echo Garden</Card.Title>
          <Card.Description>Sunday 20 Apr — Princess Theatre</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>Friday 25 Apr — The Zoo</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>Saturday 3 May — Black Bear Lodge</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
  </Carousel.Content>
...
```tsx-live
<Carousel aria-label='Comedy lineup' opts={{ align: 'start' }}>
  <Carousel.Header>
  ...
  <Carousel.Content>
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/wil-anderson'>
        <Card.Content>
          <Card.Title>Wil Anderson — Wilegitimate</Card.Title>
          <Card.Description>29 Jun · 9:00 PM</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/wynnum-fringe'>
        <Card.Content>
          <Card.Title>Wynnum Fringe Comedy Gala</Card.Title>
          <Card.Description>3 Jul · 8:15 PM</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/dave-thornton'>
        <Card.Content>
          <Card.Title>Dave Thornton — Nothing's Impossible</Card.Title>
...
| `Carousel.Dots` | One button per slide. Auto-hides when there's nothing to scroll to. |
