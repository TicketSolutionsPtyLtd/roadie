    ...
    <Carousel.Item className='basis-[42%] md:basis-1/3'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>The Driftwood Theatre</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
  </Carousel.Content>
    ...
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/midnight-frequency'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-03-14T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; The Glasshouse
          </Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/sunset-sounds'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-03-22T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; Riverbend Park
          </Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/neon-dusk'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-03-30T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; Northside Hall
          </Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/wave-theory'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-04-05T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; The Lantern
          </Card.Description>
...
### With deferred images

Embla mounts every slide in the DOM, so native `loading='lazy'` still fetches off-screen slides. Give each `Card.Image` a `width` and `defer` so the full image only loads once the slide nears the viewport, the canonical pattern for image-heavy carousels. `placeholder='blur'` keeps the tile from popping in.

```tsx-live
<Carousel aria-label='Events with artwork'>
  <Carousel.Header>
    <Carousel.TitleLink href='/events'>What's on</Carousel.TitleLink>
    <Carousel.Controls>
      <Carousel.Previous />
      <Carousel.Next />
    </Carousel.Controls>
  ...
  <Carousel.Content>
    {[
      ...
      <Carousel.Item key={title} className='basis-[78%] md:basis-1/3'>
        <Card emphasis='raised' href={`/events/${i}`}>
          <Card.Image
...
Roadie defaults `slidesToScroll` to `'auto'` in `opts`, so Previous / Next move by a full viewport at a time instead of a single slide. Embla derives the group size from whatever currently fits in the viewport, so the same carousel scrolls two-and-a-bit cards on mobile, three on medium screens, and four on large screens, with no breakpoint-specific configuration needed. Because `Carousel.Dots` renders one dot per _snap_, the dot count also collapses from one-per-slide down to one-per-page as the breakpoint changes.
    ...
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-04-12T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; Hillside Tavern
          </Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-04-20T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; The Driftwood Theatre
          </Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-04-25T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; The Aviary
          </Card.Description>
    ...
    <Carousel.Item className='basis-[42%] md:basis-1/3 lg:basis-1/4'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-05-03T09:30:00Z')}
              timeZone='Australia/Brisbane'
            />{' '}
            &middot; Foxglove Lodge
          </Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    ...
    <Carousel.Item className='basis-[82%] md:basis-1/2'>
      <Card emphasis='subtle'>
        <Card.Content>
          ...
          <Card.Description>How a Sunday matinee at The Palisade Theatre turned into a live album.</Card.Description>
        </Card.Content>
      </Card>
    </Carousel.Item>
    <Carousel.Item className='basis-[82%] md:basis-1/2'>
...
Fixed group sizes also work: `opts={{ slidesToScroll: 3 }}` always advances three at a time regardless of viewport. See the full list of Embla options in the [Embla Carousel options reference](https://www.embla-carousel.com/api/options/).
...
>
  <Carousel.Header>
    <Carousel.TitleLink render={<Link href='/events' />}>
      Featured events
    </Carousel.TitleLink>
    <Carousel.Dots />
    <Carousel.Controls>
    ...
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/eli-bramble'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-06-29T11:00:00Z')}
              timeZone='Australia/Brisbane'
              timeStyle='medium'
            />
          </Card.Description>
    ...
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/riverside-fringe'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-07-03T10:15:00Z')}
              timeZone='Australia/Brisbane'
              timeStyle='medium'
            />
          </Card.Description>
    ...
    <Carousel.Item className='basis-[78%] md:basis-1/3'>
      <Card emphasis='raised' href='/events/casey-vale'>
        <Card.Content>
          ...
          <Card.Description>
            <DateTime
              at={new Date('2026-07-05T06:45:00Z')}
              timeZone='Australia/Brisbane'
              timeStyle='medium'
            />
          </Card.Description>
...
| `Carousel.Title`                      | `<h2>` by default; pass `render={<h3 />}` (etc.) to change the heading level. Registers as the carousel's accessible name.                                                                                                         |
| `Carousel.TitleLink`                  | Anchor with a trailing arrow icon. Pass `render={<Link />}` to use a framework router link. Registers as the carousel's accessible name.                                                                                           |
...
| `Carousel.Dots`                       | One button per scroll snap position (which can be fewer than `slideCount` when multi-visible layouts group slides into viewport-sized pages, the Roadie default). Auto-hides when there's nothing to scroll to.                   |
...
```tsx
function useCarousel(): { state: CarouselState; actions: CarouselActions }
```

Read state and call actions from a child component. Must be called inside a `<Carousel>` tree.

| Field | Type | Description |
| --- | --- | --- |
| `state.direction` | `'horizontal' \| 'vertical'` | The carousel's scroll axis. |
| `state.selectedIndex` | `number` | Selected snap index (0-based). A snap may cover multiple slides. |
| `state.slideCount` | `number` | Number of `Carousel.Item` children. |
| `state.snapCount` | `number` | Number of distinct Embla scroll snap positions. |
| `state.canGoToPrev` | `boolean` | Whether `goToPrev` moves anywhere. |
| `state.canGoToNext` | `boolean` | Whether `goToNext` moves anywhere. |
| `state.canScroll` | `boolean` | False when every slide already fits in the viewport. |
| `state.isPlaying` | `boolean` | Autoplay's current state. |
| `state.userPaused` | `boolean` | True once the user explicitly pauses. |
| `state.labelId` | `string \| undefined` | Id of the element supplying the accessible name. |
| `state.rootAriaLabel` | `string \| undefined` | The root's `aria-label`, when set directly. |
| `actions.goToPrev` | `() => void` | Move to the previous snap. |
| `actions.goToNext` | `() => void` | Move to the next snap. |
| `actions.goTo` | `(index: number) => void` | Move to a specific snap. |
| `actions.play` | `() => void` | Start or resume autoplay. |
| `actions.pause` | `() => void` | Pause autoplay. |
| `actions.toggle` | `() => void` | Toggle autoplay. |

### useCarouselUnsafeEmbla

```tsx
function useCarouselUnsafeEmbla(): EmblaCarouselType | undefined
```

Escape hatch: returns the raw Embla `api` instance. Hard-couples your code to a specific `embla-carousel` major version, so prefer `useCarousel()` whenever its state and actions are sufficient. This hook exists so raw-Embla usage stays greppable when planning an upgrade.

<PropsDefinitions componentPath='packages/components/src/components/Carousel' />
