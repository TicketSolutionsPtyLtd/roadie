...
| `descriptions={false}` | Drops the descriptions. |
...
before your detail pane. `<Navigator.SectionItems descriptions={false} />`
...
account menu. `Navigator.MenuItem` takes an `href` or an `onClick`, plus an
