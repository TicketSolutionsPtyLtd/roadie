...
<div className="intent-accent emphasis-subtle emphasis-default-fg p-4 rounded-lg">
...
<div className="intent-accent emphasis-strong-surface emphasis-subtle-fg">
...
<div className="emphasis-default-surface emphasis-default-fg emphasis-subtle-border p-4 rounded-lg">
