...
<div className="bg-neutral-3 text-neutral-12 p-4 rounded-lg">
  Content using token-backed utilities
</div>
```
...
<div className="bg-neutral-1 text-neutral-12 border border-neutral-7">
