...
- Name a band and the median drawn through it as one item. Pass the median's colour as `median` and the key draws the dashed line through the band, as the plot does.
