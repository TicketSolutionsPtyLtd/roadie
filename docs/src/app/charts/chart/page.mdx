...
- Live plot heights come from the card size: `size='sm'` is 160px, `md` is 220px, `lg` and `full` are 260px.
...
- Switching between Chart and Table keeps the card's height. The plot sets it, and a longer table scrolls inside it.
