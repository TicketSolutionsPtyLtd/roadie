...
<Dashboard>
  <Dashboard.Section title='At a glance'>
    ...
    <StatTile label='Sell-through' value={0.77} format='percent' delta={{ value: 9, format: 'points' }} context='This week. Target 85%' />
    <StatTile label='Pace index' value={112} format='index' context='Against similar shows' />
    <StatTile label='Gross revenue' value={118400} format='compactCurrency' delta={{ value: -0.04, format: 'percent' }} context='Last week, before fees' />
  </Dashboard.Section>
</Dashboard>
```
