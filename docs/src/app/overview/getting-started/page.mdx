export const metadata = {
  ...
  description: 'Learn how to set up and start using the Roadie Design System in your project'
}
...
function MyComponent() {
  return (
    <View gap="400" flexDirection="column">
      <div>Item 1</div>
      <div>Item 2</div>
    </View>
  )
...
- Learn about our [Design Tokens](/foundations/tokens) and how to use them
