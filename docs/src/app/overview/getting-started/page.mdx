...
### 4. Mount the providers

Wrap your app once, at the root. `RoadieLinkProvider` routes every `href` through your router, `ThemeProvider` handles light and dark, and `Toast.Provider` with `Toast.Viewport` shows the [toasts](/components/toast) any component adds.
