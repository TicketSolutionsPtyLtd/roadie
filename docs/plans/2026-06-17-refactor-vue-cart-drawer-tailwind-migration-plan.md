...
| `.rc-header__close`      | `absolute top-0 left-4` (+ inline opacity) → inner close = `IconButton`-equivalent: `btn-icon btn-icon-sm is-interactive emphasis-subtle intent-neutral` + `PhX size-4`                                                                         | :103,111                              |
...
| trash button                     | `btn-icon btn-icon-sm is-interactive emphasis-subtler intent-danger` + `PhTrash size-4`                                        | :87                                 |
...
| `.rc-modal__close`              | `absolute top-4 right-4` → `btn-icon btn-icon-sm is-interactive emphasis-subtle intent-neutral` + `PhX size-4`               | :67                          |
